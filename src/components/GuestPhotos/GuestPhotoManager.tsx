...
export function GuestPhotoManager() {
  ...
  if (selectedEvent) {
    return (
      <FeatureGate
        featureType="photo_uploads"
        featureName="Guest Photo Collection"
        description="Create photo events and let your guests share their memories with you. Collect unlimited photos from your special day."
      >
        <GuestPhotoGallery 
